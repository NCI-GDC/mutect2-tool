...
import tools.mutect2_tool as mutect2_tool
...
def main():
    ...
    mutect2_tool.run_mutect2(case_id, normal_id, normal_bam_path, tumor_id, tumor_bam_path, known_snp_vcf_path, cosmic_path, thread_count, java_heap, reference_fasta_path, contEst, pon_path, fai_path, blocksize, engine, logger, mode)
